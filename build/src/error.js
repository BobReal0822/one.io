...
exports.ErrorMessage = {
    ...
    tocken: {
        unknown: utils_1.generateMessage('5000', 'Unknown tocken error!'),
        missing: utils_1.generateMessage('5001', 'Missing tocken!'),
        invalid: utils_1.generateMessage('5002', 'Tocken invalid!')
    },
    route: {
